		...
		<table style="border-spacing: 0;">
			<tr>
				<td valign="top" style="font-size: 14px; line-height: 16px; font-family: Helvetica, Arial, sans-serif; padding-bottom: 14px;">
					...
					<?php if ( '' !== $user->dbi_position ) { echo "<span style='font-size:12px;'>{$user->dbi_position}, </span>"; } ?><a style="font-size: 12px; color: #000000;" href="https://deliciousbrains.com?utm_source=Email%20marketing%20software&utm_medium=email&utm_campaign=email-signature">Delicious Brains Inc.</a>
				</td>
				<td>&nbsp;&nbsp;</td>
				<td>
